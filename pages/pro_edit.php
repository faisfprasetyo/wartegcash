...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-10 border-bottom-info">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-info">Edit Menu</h4>
            </div>
            <div class="card-body">
            ...
            <form role="form" method="post" action="pro_edit1.php">
              ...
              <hr>
              <?php echo "<a href='delete.php?product_id=".$_GET['id']."'> <button type='button' class='btn btn-success'>Hapus Menu</button>";?>
                <button type="submit" class="btn btn-success">Perbarui</button>    
                <a href="product.php?action=add" type="button" class="btn btn-dark">Kembali</a>
</form>  
            </div>
          </div>
