...
function pre_r($array){
    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <li class="nav-item">
                  <a class="nav-link" href="#" data-target="#food" data-toggle="tab">Makanan</a>
                  </li>
                  <li class="nav-item">
                  <a class="nav-link" href="#" data-target="#ice" data-toggle="tab">Minuman Dingin</a>
                  </li>
                  <li class="nav-item">
                  <a class="nav-link" href="#hot" data-toggle="tab">Minuman Hangat</a>
                  </li>
                  <li class="nav-item">
                  <a class="nav-link" href="#snack" data-toggle="tab">Cemilan</a>
                  </li>
                  </ul>
...
Warteg <span class ="text-danger">Cash</span> </h4>
          <p>
            <div class="row">
...
<form role="form" method="post" action="pos_transac.php?action=add">
  ...
  <hr/>
  <h3 class="text-center">Detail Pemesanan</h3>
  <hr/>
        <table class="table">    
        ...
        <tr>  
           ...
           <td>
            ...
            Rp. <?php echo $product['quantity'] * $product['price']; ?></td>  
           <td>
