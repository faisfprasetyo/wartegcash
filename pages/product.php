...
$aaa = "<select class='form-control' name='category' required>
        <option disabled selected hidden>Pilih KategoI</option>";
  while ($row = mysqli_fetch_assoc($result)) {
...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-info text-center">Daftar Menu&nbsp;<br/>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['CNAME'].'</td>';
                      echo '<td align="right"> <div class="btn-group">
                                  ...
                                  <br>
                                  <a type="button" class="btn btn-info btn-block" style="border-radius: 0px;" href="delete.php?action=edit & product_id='.$row['PRODUCT_ID']. '">
                                    Hapus Menu
                                  </a>
                              </td>';
                echo '</tr> ';
        ...
        <div class="modal-body">
          <form role="form" method="post" action="pro_transac.php?action=add">
           <div class="form-group">
             <input class="form-control" placeholder="ID Menu" name="prodcode" required>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            ...
            <hr>
            <button type="submit" class="btn btn-info"><i class="fa fa-check fa-fw"></i>Simpan</button>
